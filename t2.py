...
with st.sidebar:
    ...
    with st.expander("ℹ️ About this App"):
        st.write("""
            This AI-powered assistant is designed to help you quickly analyze and understand compliance data from AWS.
            
            **Key Features:**
            - **IAM & S3 Summaries:** Get automated, high-level compliance reports.
            - **Natural Language Queries:** Ask specific questions about your data in plain English.
            - **Generic CSV Analysis:** Get a quick overview of any CSV file.
        """)
    ...
    st.markdown(
        ...
        <div style='text-align: center; font-size: 0.9rem; color: #808080;'>
            ...
            <a href="https://github.com/your-username" target="_blank">GitHub</a> | <a href="https://linkedin.com/in/your-profile" target="_blank">LinkedIn</a>
        </div>
        """,
        unsafe_allow_html=True
    )
...
with st.expander("📖 How to Use This App"):
    st.markdown("""
    1.  **Select AI Provider:** Choose between OpenAI and Google Gemini in the sidebar.
    2.  **Enter API Key:** Provide your corresponding API key. Your key is not stored.
    3.  **Select Report Type:**
        - **Query:** Ask a specific question about your data.
        - **Summary:** Get a full, automated overview.
    4.  **Upload File:** Upload your CSV report.
    5.  **Get Analysis:** Click the button to get insights!
    """)
